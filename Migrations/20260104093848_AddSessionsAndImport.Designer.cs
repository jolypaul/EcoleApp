...
namespace EcoleApp.Migrations
{
    ...
    [Migration("20260104093848_AddSessionsAndImport")]
    partial class AddSessionsAndImport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoleApp.Models.Entity.Auth.Session", b =>
                {
            ...
            modelBuilder.Entity("EcoleApp.Models.Entity.Auth.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ADMIN-001",
                            Email = "admin@237.com",
                            MotDePasseHash = "uaCC25mkO69Wq3kYe7yksg==.QX/poa93n8valy4SX9XTWzJNP6IESiX8odRohplt5D4=",
            ...
            modelBuilder.Entity("EcoleApp.Models.Entity.Auth.Session", b =>
                {
                    b.HasOne("EcoleApp.Models.Entity.Auth.Utilisateur", null)
                        .WithMany()
                        .HasForeignKey("UtilisateurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
